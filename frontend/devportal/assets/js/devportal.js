(function () {
  ...
  var I18N = {
    pt: {
      ...
      'ui.portalTitle': 'Developer Portal da API Arah',
      'ui.lang': 'Idioma',
      'ui.backHome': '← Voltar para arah.app',
      'ui.heroTag': 'Arah API • Developer Portal',
      'ui.heroTitle': 'Infraestrutura territorial para comunidades locais.',
      'ui.heroLeadHtml': 'O Arah é uma plataforma comunitária <strong>territory-first</strong>. O território organiza contexto, visibilidade e governança. Este portal documenta o produto e a API exatamente como implementada hoje, para acelerar o onboarding de desenvolvedores com segurança e previsibilidade.',
      'overview.eyebrow': 'Visão geral',
      'overview.title': 'API orientada a território + curadoria comunitária.',
      'overview.lead': 'A API do Arah cria um núcleo confiável para território, vínculos, feed, mapa, marketplace, eventos e chat. Ela prioriza regras explícitas (visibilidade, validação e moderação) para que experiências locais sejam auditáveis e evoluam com segurança.',
      'how.eyebrow': 'Como o Arah funciona',
      ...
      'quickstart.tipHtml': '<strong>Dica:</strong> fonte única do portal em <code>backend/Arah.Api/wwwroot/devportal</code>. O GitHub Pages publica exatamente essa pasta.',
      ...
      'nav.howItWorks': 'Como o Arah funciona',
    ...
    es: {
      ...
      'ui.portalTitle': 'Portal de Desarrolladores de la API Arah',
      'ui.lang': 'Idioma',
      'ui.backHome': '← Volver a arah.app',
      'ui.heroTag': 'Arah API • Portal de Desarrolladores',
      'ui.heroTitle': 'Infraestructura territorial para comunidades locales.',
      'ui.heroLeadHtml': 'Arah es una plataforma comunitaria <strong>territory-first</strong>. El territorio organiza contexto, visibilidad y gobernanza. Este portal documenta el producto y la API tal como están implementados hoy, para acelerar el onboarding de desarrolladores con seguridad y previsibilidad.',
      'overview.eyebrow': 'Visión general',
      'overview.title': 'API orientada al territorio + curaduría comunitaria.',
      'overview.lead': 'La API de Arah crea un núcleo confiable para territorio, vínculos, feed, mapa, marketplace y eventos. Prioriza reglas explícitas (visibilidad, validación y moderación) para que las experiencias locales sean auditables y evolucionen con seguridad.',
      'how.eyebrow': 'Cómo funciona Arah',
      ...
      'quickstart.bashTitle': 'Bash (Linux/macOS/Git Bash)',
      'quickstart.powershellTitle': 'PowerShell (Windows)',
      'quickstart.tipHtml': '<strong>Consejo:</strong> la fuente única del portal está en <code>backend/Arah.Api/wwwroot/devportal</code>. GitHub Pages publica exactamente esa carpeta.',
      ...
      'nav.howItWorks': 'Cómo funciona Arah',
      ...
      'admin.leadHtml': 'Para soportar validaciones y gobernanza con trazabilidad, la API implementa <strong>SystemConfig</strong> (configuración calibrable), <strong>WorkItem</strong> (cola genérica de revisión humana) y <strong>DocumentEvidence</strong> (metadatos de documentos con upload y descarga por proxy). Lee el documento completo en <a href=\"https://github.com/sraphaz/arah/blob/main/docs/33_ADMIN_SYSTEM_CONFIG_WORKQUEUE.md\" rel=\"noopener\">docs/33_ADMIN_SYSTEM_CONFIG_WORKQUEUE.md</a>.',
    ...
    en: {
      ...
      'ui.portalTitle': 'Arah API Developer Portal',
      'ui.lang': 'Language',
      'ui.backHome': '← Back to arah.app',
      'ui.heroTag': 'Arah API • Developer Portal',
      'ui.heroTitle': 'Territory infrastructure for local communities.',
      'ui.heroLeadHtml': 'Arah is a community platform that is <strong>territory-first</strong>. Territory organizes context, visibility, and governance. This portal documents the product and the API exactly as implemented today, to speed up developer onboarding with safety and predictability.',
      'overview.eyebrow': 'Overview',
      'overview.title': 'Territory-oriented API + community curation.',
      'overview.lead': 'Arah’s API provides a reliable core for territory, memberships, feed, map, marketplace, and events. It prioritizes explicit rules (visibility, validation, and moderation) so local experiences are auditable and evolve safely.',
      'how.eyebrow': 'How Arah works',
      ...
      'quickstart.bashTitle': 'Bash (Linux/macOS/Git Bash)',
      'quickstart.powershellTitle': 'PowerShell (Windows)',
      'quickstart.tipHtml': '<strong>Tip:</strong> single source of truth lives in <code>backend/Arah.Api/wwwroot/devportal</code>. GitHub Pages deploys that folder as-is.',
      ...
      'admin.leadHtml': 'To support validations and governance with traceability, the API provides <strong>SystemConfig</strong> (calibratable settings), <strong>WorkItem</strong> (a generic human review queue), and <strong>DocumentEvidence</strong> (document metadata with upload and proxy download). Read the full doc at <a href=\"https://github.com/sraphaz/arah/blob/main/docs/33_ADMIN_SYSTEM_CONFIG_WORKQUEUE.md\" rel=\"noopener\">docs/33_ADMIN_SYSTEM_CONFIG_WORKQUEUE.md</a>.',
    ...
    it: {
      ...
      'ui.portalTitle': 'Portale Sviluppatori API Arah',
      'ui.lang': 'Lingua',
      'ui.backHome': '← Torna a arah.app',
      'ui.heroTag': 'Arah API • Portale Sviluppatori',
      'ui.heroTitle': 'Infrastruttura territoriale per comunità locali.',
      'ui.heroLeadHtml': 'Arah è una piattaforma comunitaria <strong>territory-first</strong>. Il territorio organizza contesto, visibilità e governance. Questo portale documenta il prodotto e l’API esattamente come sono implementati oggi, per accelerare l’onboarding degli sviluppatori con sicurezza e prevedibilità.',
      'overview.eyebrow': 'Panoramica',
      'overview.title': 'API orientata al territorio + curatela della comunità.',
      'overview.lead': 'L’API di Arah fornisce un nucleo affidabile per territorio, memberships, feed, mappa, marketplace ed eventi. Dà priorità a regole esplicite (visibilità, validazione e moderazione) affinché le esperienze locali siano verificabili e possano evolvere in sicurezza.',
      'how.eyebrow': 'Come funziona Arah',
      ...
      'quickstart.bashTitle': 'Bash (Linux/macOS/Git Bash)',
      'quickstart.powershellTitle': 'PowerShell (Windows)',
      'quickstart.tipHtml': '<strong>Suggerimento:</strong> fonte unica in <code>backend/Arah.Api/wwwroot/devportal</code>. GitHub Pages pubblica esattamente quella cartella.',
      ...
      'nav.howItWorks': 'Come funziona Arah',
      ...
      'admin.leadHtml': 'Per supportare validazioni e governance con tracciabilità, l’API fornisce <strong>SystemConfig</strong> (impostazioni calibrabili), <strong>WorkItem</strong> (coda generica di revisione umana) e <strong>DocumentEvidence</strong> (metadati dei documenti con upload e download via proxy). Leggi il documento completo in <a href=\"https://github.com/sraphaz/arah/blob/main/docs/33_ADMIN_SYSTEM_CONFIG_WORKQUEUE.md\" rel=\"noopener\">docs/33_ADMIN_SYSTEM_CONFIG_WORKQUEUE.md</a>.',
    ...
    hi: {
      ...
      'ui.portalTitle': 'Arah API डेवलपर पोर्टल',
      'ui.lang': 'भाषा',
      'ui.backHome': '← arah.app पर वापस जाएँ',
      'ui.heroTag': 'Arah API • डेवलपर पोर्टल',
      'ui.heroTitle': 'स्थानीय समुदायों के लिए क्षेत्रीय अवसंरचना।',
      'ui.heroLeadHtml': 'Arah एक <strong>territory-first</strong> समुदाय प्लेटफ़ॉर्म है। Territory संदर्भ, visibility और governance को व्यवस्थित करता है। यह पोर्टल आज जैसी लागू की गई product और API को दस्तावेज़ करता है, ताकि developer onboarding सुरक्षित और पूर्वानुमेय रूप से तेज़ हो सके।',
      ...
      'nav.title': 'विषयसूची',
      'nav.overview': 'सारांश',
      'nav.howItWorks': 'Arah कैसे काम करता है',
      ...
      'admin.leadHtml': 'Traceability के साथ validations और governance को सपोर्ट करने के लिए API <strong>SystemConfig</strong> (calibratable settings), <strong>WorkItem</strong> (generic human review queue) और <strong>DocumentEvidence</strong> (upload + proxy download के साथ document metadata) प्रदान करती है। पूरा डॉक पढ़ें: <a href=\"https://github.com/sraphaz/arah/blob/main/docs/33_ADMIN_SYSTEM_CONFIG_WORKQUEUE.md\" rel=\"noopener\">docs/33_ADMIN_SYSTEM_CONFIG_WORKQUEUE.md</a>.',
      ...
      'overview.lead': 'Arah की API territory, memberships, feed, map, marketplace और events के लिए एक भरोसेमंद core देती है। यह explicit rules (visibility, validation, moderation) को प्राथमिकता देती है ताकि स्थानीय अनुभव audit-योग्य रहें और सुरक्षित रूप से विकसित हों।',
      'how.eyebrow': 'Arah कैसे काम करता है',
