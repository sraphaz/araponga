...
- **Plataformas:** se o projeto ainda não tiver `android/` e `ios/`, o CD executa `flutter create . --project-name arah_app --org com.arah --platforms=android,ios,web` antes do build (o nome do pacote é `arah_app`).
