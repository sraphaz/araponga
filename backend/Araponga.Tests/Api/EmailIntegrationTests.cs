...
public sealed class EmailIntegrationTests
{
    ...
    public async Task UpdateEmailPreferences_WithValidData_UpdatesSuccessfully()
    {
        ...
        var token = await LoginForTokenAsync(client, "google", "test-email-prefs", "test@araponga.com");
    ...
    public async Task UpdateEmailPreferences_WithInvalidFrequency_ReturnsBadRequest()
    {
        ...
        var token = await LoginForTokenAsync(client, "google", "test-email-invalid", "test@araponga.com");
        client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
    ...
    public async Task GetPreferences_IncludesEmailPreferences()
    {
        ...
        var token = await LoginForTokenAsync(client, "google", "test-email-get", "test@araponga.com");
        client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
    ...
    public async Task EmailQueue_EnqueuesEmail_WhenNotificationRequiresEmail()
    {
        ...
        var token = await LoginForTokenAsync(client, "google", "test-email-queue", "test@araponga.com");
        client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
    ...
    public async Task EmailPreferences_RespectsOptOut()
    {
        ...
        var token = await LoginForTokenAsync(client, "google", "test-email-optout", "test@araponga.com");
        client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
