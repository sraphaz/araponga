...
public sealed class GovernanceIntegrationTests
{
    ...
    public async Task AddInterest_WhenValid_ReturnsSuccess()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-interest-1");
    ...
    public async Task ListInterests_WhenUserHasInterests_ReturnsList()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-interest-2");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
    ...
    public async Task RemoveInterest_WhenExists_ReturnsSuccess()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-interest-3");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
    ...
    public async Task CreateVoting_WhenValid_ReturnsSuccess()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-voting-1");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
    ...
    public async Task Vote_WhenVotingIsOpen_ReturnsSuccess()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-voting-2");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
    ...
    public async Task GetVotingResults_WhenVotingExists_ReturnsResults()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-voting-3");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
    ...
    public async Task ListVotings_WhenTerritoryHasVotings_ReturnsList()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-voting-4");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
    ...
    public async Task UserProfile_IncludesInterests()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-profile-1");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
    ...
    public async Task Feed_WithFilterByInterests_ReturnsOnlyMatchingPosts()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-feed-filter-1");
        AuthTestHelper.SetupAuthenticatedClient(client, token, "feed-filter-session");
    ...
    public async Task Visitor_CannotVote_OnResidentsOnlyVoting()
    {
        ...
        var residentToken = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-resident-1");
        ...
        var visitorToken = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-visitor-1");
        AuthTestHelper.SetupAuthenticatedClient(client, visitorToken);
    ...
    public async Task Visitor_CannotVote_OnCuratorsOnlyVoting()
    {
        ...
        var curatorToken = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-curator-1");
        AuthTestHelper.SetupAuthenticatedClient(client, curatorToken);
        ...
        var visitorToken = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-visitor-2");
        AuthTestHelper.SetupAuthenticatedClient(client, visitorToken);
        var visitorUserId = await GetUserIdAsync(client);
        await CreateMembershipAsync(factory, visitorUserId, ActiveTerritoryId, MembershipRole.Visitor);
    ...
    public async Task Resident_CannotCreate_ModerationRuleVoting()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-resident-2");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
        var userId = await GetUserIdAsync(client);
        await CreateMembershipAsync(factory, userId, ActiveTerritoryId, MembershipRole.Resident);
    ...
    public async Task Resident_CannotCreate_FeatureFlagVoting()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-resident-3");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
        var userId = await GetUserIdAsync(client);
        await CreateMembershipAsync(factory, userId, ActiveTerritoryId, MembershipRole.Resident);
    ...
    public async Task User_CannotVoteTwice_OnSameVoting()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-double-vote");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
        var userId = await GetUserIdAsync(client);
        await CreateMembershipAsync(factory, userId, ActiveTerritoryId, MembershipRole.Resident);
    ...
    public async Task User_CannotClose_OtherUsersVoting()
    {
        ...
        var creatorToken = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-creator");
        AuthTestHelper.SetupAuthenticatedClient(client, creatorToken);
        ...
        var otherToken = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-other-user");
        AuthTestHelper.SetupAuthenticatedClient(client, otherToken);
    ...
    public async Task Curator_CanClose_AnyVoting()
    {
        ...
        // Criar usuário que cria votação
        var creatorToken = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-creator-2");
        AuthTestHelper.SetupAuthenticatedClient(client, creatorToken);
        var creatorUserId = await GetUserIdAsync(client);
        await CreateMembershipAsync(factory, creatorUserId, ActiveTerritoryId, MembershipRole.Resident);
        ...
        // Criar curador
        var curatorToken = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-security-curator-close");
        AuthTestHelper.SetupAuthenticatedClient(client, curatorToken);
        var curatorUserId = await GetUserIdAsync(client);
        await CreateMembershipAsync(factory, curatorUserId, ActiveTerritoryId, MembershipRole.Resident);
        await CreateCuratorCapabilityAsync(factory, curatorUserId, ActiveTerritoryId);
