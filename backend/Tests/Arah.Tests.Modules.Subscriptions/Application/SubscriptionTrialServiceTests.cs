...
namespace Arah.Tests.Modules.Subscriptions.Application;
...
public sealed class SubscriptionTrialServiceTests
{
    ...
    public async Task ProcessExpiredTrialsAsync_SendsNotification_WhenTrialEnded()
    {
        ...
        _subscriptionRepositoryMock
            ...
            .Returns(Task.CompletedTask);
        _outboxMock
            .Setup(o => o.EnqueueAsync(It.IsAny<Arah.Application.Models.OutboxMessage>(), It.IsAny<CancellationToken>()))
            .Returns(Task.CompletedTask);
        _unitOfWorkMock
            .Setup(u => u.CommitAsync(It.IsAny<CancellationToken>()))
            .Returns(Task.CompletedTask);
        ...
        // Assert
        Assert.True(result.IsSuccess);
        _outboxMock.Verify(o => o.EnqueueAsync(It.IsAny<Arah.Application.Models.OutboxMessage>(), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task ProcessExpiredTrialsAsync_HandlesMultipleExpiredTrials()
    {
        ...
        _outboxMock.Verify(o => o.EnqueueAsync(It.IsAny<Arah.Application.Models.OutboxMessage>(), It.IsAny<CancellationToken>()), Times.Exactly(2));
    }
