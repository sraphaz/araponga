...
public sealed class SubscriptionIntegrationTests
{
    ...
    public async Task GetMySubscription_ReturnsFreePlan_WhenNoActiveSubscription()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-sub-free", "test@Arah.com");
    ...
    public async Task CreateSubscription_WithValidPlan_CreatesSubscription()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-sub-create", "test@Arah.com");
        AuthTestHelper.SetAuthHeader(client, token);
    ...
    public async Task CancelSubscription_WithValidSubscription_CancelsSubscription()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-sub-cancel", "test@Arah.com");
        AuthTestHelper.SetAuthHeader(client, token);
