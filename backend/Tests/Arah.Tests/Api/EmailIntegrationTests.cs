...
public sealed class EmailIntegrationTests
{
    ...
    public async Task UpdateEmailPreferences_WithValidData_UpdatesSuccessfully()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-email-prefs", "test@Arah.com");
    ...
    public async Task UpdateEmailPreferences_WithInvalidFrequency_ReturnsBadRequest()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-email-invalid", "test@Arah.com");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
    ...
    public async Task GetPreferences_IncludesEmailPreferences()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-email-get", "test@Arah.com");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
    ...
    public async Task EmailQueue_EnqueuesEmail_WhenNotificationRequiresEmail()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-email-queue", "test@Arah.com");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
    ...
    public async Task EmailPreferences_RespectsOptOut()
    {
        ...
        var token = await AuthTestHelper.LoginForTokenAsync(client, "google", "test-email-optout", "test@Arah.com");
        AuthTestHelper.SetupAuthenticatedClient(client, token);
