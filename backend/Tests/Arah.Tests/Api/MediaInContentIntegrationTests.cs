...
public sealed class MediaInContentIntegrationTests
{
    ...
    public async Task CreatePost_WithVideoTooLarge_ReturnsBadRequest()
    {
        ...
        var mediaRepository = new Arah.Infrastructure.InMemory.InMemoryMediaAssetRepository(dataStore);
        ...
        if (video != null)
        {
            ...
            var largeVideo = new Arah.Domain.Media.MediaAsset(
                Guid.NewGuid(),
                video.UploadedByUserId,
                Arah.Domain.Media.MediaType.Video,
                video.MimeType,
