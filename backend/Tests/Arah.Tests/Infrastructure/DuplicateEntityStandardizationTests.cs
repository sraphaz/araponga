...
/// Arah.Infrastructure/Postgres/Entities e Arah.Infrastructure.Shared/Postgres/Entities.
...
{
    private static readonly Assembly InfraAssembly = typeof(Arah.Infrastructure.Postgres.Entities.TerritoryRecord).Assembly;
    private const string InfraEntitiesNamespace = "Arah.Infrastructure.Postgres.Entities";

    private static readonly Assembly SharedAssembly = typeof(Arah.Infrastructure.Shared.Postgres.Entities.TerritoryRecord).Assembly;
    private const string SharedEntitiesNamespace = "Arah.Infrastructure.Shared.Postgres.Entities";
