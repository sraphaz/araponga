...
public sealed class DomainValidationTests
{
    ...
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            new User(Guid.NewGuid(), "", "user@Arah.com", "123.456.789-00", null, null, null, "google", "ext", DateTime.UtcNow));
    ...
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            new User(Guid.NewGuid(), "User", "user@Arah.com", "123.456.789-00", null, null, null, "", "ext", DateTime.UtcNow));
    ...
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            new User(Guid.NewGuid(), "User", "user@Arah.com", "123.456.789-00", null, null, null, "google", "", DateTime.UtcNow));
    ...
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            new Arah.Domain.Health.HealthAlert(
                Guid.NewGuid(),
                Guid.Empty,
                Guid.NewGuid(),
                "Título",
                "Descrição",
                Arah.Domain.Health.HealthAlertStatus.Pending,
                DateTime.UtcNow));
    ...
    {
        var alert = new Arah.Domain.Health.HealthAlert(
            Guid.NewGuid(),
            Guid.NewGuid(),
            Guid.NewGuid(),
            "Título",
        ...
        alert.UpdateStatus(Arah.Domain.Health.HealthAlertStatus.Validated);

        Assert.Equal(Arah.Domain.Health.HealthAlertStatus.Validated, alert.Status);
    }
}
