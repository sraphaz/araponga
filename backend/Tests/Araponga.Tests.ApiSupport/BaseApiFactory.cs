...
namespace Araponga.Tests.ApiSupport;
...
/// Araponga.Tests e Araponga.Tests.Modules.Subscriptions usam esta base para manter sincronia (evitar duplicação de env vars).
/// </summary>
