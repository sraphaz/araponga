...
/// <summary>
/// Service responsible for post interactions (likes, comments, shares) in the Feed module.
/// </summary>
public sealed class PostInteractionService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (post.Visibility == Araponga.Domain.Feed.PostVisibility.ResidentsOnly)
        {
            if (userId is null)
            {
                return false;
        ...
        CancellationToken cancellationToken)
    {
        ...
        var comment = new Araponga.Domain.Feed.PostComment(Guid.NewGuid(), postId, userId, content, DateTime.UtcNow);
