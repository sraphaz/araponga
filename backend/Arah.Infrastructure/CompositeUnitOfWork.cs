...
namespace Arah.Infrastructure;

/// <summary>
/// Unidade de trabalho que agrega múltiplos participantes (ArahDbContext, SharedDbContext, DbContexts dos módulos).
...
/// (ex.: ArahDbContext), pois transação distribuída entre vários DbContexts não é implementada.
/// </summary>
