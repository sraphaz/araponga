...
namespace Arah.Infrastructure.Outbox;
...
public sealed class OutboxDispatcherWorker : BackgroundService
{
    ...
    private async Task ProcessBatchAsync(CancellationToken stoppingToken)
    {
        ...
        var dbContext = scope.ServiceProvider.GetRequiredService<ArahDbContext>();
        ...
        var notificationConfigService = scope.ServiceProvider.GetService<Arah.Application.Services.Notifications.NotificationConfigService>();
        var configuration = scope.ServiceProvider.GetService<Microsoft.Extensions.Configuration.IConfiguration>();
        var baseUrl = configuration?["BaseUrl"] ?? "https://Arah.com";
        ...
        CancellationToken cancellationToken)
    {
        ...
        Arah.Application.Common.Result<Arah.Domain.Notifications.NotificationConfig>? notificationConfig = null;
        if (notificationConfigService is Arah.Application.Services.Notifications.NotificationConfigService service)
        {
