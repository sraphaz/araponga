...
public interface IWorkItemRepository
{
    ...
    Task<IReadOnlyList<WorkItem>> ListAsync(WorkItemType? type, WorkItemStatus? status, Guid? territoryId, CancellationToken cancellationToken);
    Task<WorkItem?> GetLatestOpenBySubjectAsync(WorkItemType type, string subjectType, Guid subjectId, CancellationToken cancellationToken);
