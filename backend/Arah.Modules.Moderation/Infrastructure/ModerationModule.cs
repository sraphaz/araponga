...
using Arah.Modules.Moderation.Infrastructure.Postgres;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

namespace Arah.Modules.Moderation;
...
public sealed class ModerationModule : IModule
{
    public void RegisterServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IUnitOfWorkParticipant>(sp => new ModerationUnitOfWorkParticipant(sp.GetRequiredService<ModerationDbContext>()));
...
internal sealed class ModerationUnitOfWorkParticipant(ModerationDbContext context) : IUnitOfWorkParticipant
{
