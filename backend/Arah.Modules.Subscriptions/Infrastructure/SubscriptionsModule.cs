...
using Arah.Modules.Subscriptions.Infrastructure.Postgres;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

namespace Arah.Modules.Subscriptions;
...
public sealed class SubscriptionsModule : IModule
{
    public void RegisterServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IUnitOfWorkParticipant>(sp => new SubscriptionsUnitOfWorkParticipant(sp.GetRequiredService<SubscriptionsDbContext>()));
...
internal sealed class SubscriptionsUnitOfWorkParticipant(SubscriptionsDbContext context) : IUnitOfWorkParticipant
{
