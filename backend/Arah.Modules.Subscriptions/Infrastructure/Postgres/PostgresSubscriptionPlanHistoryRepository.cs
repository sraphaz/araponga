...
using Arah.Modules.Subscriptions.Infrastructure.Postgres.Entities;
using Microsoft.EntityFrameworkCore;

namespace Arah.Modules.Subscriptions.Infrastructure.Postgres;
...
public sealed class PostgresSubscriptionPlanHistoryRepository : ISubscriptionPlanHistoryRepository
{
    ...
    public PostgresSubscriptionPlanHistoryRepository(SubscriptionsDbContext dbContext)
    {
