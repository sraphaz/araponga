...
using Arah.Modules.Connections.Infrastructure.Postgres.Entities;
using Microsoft.EntityFrameworkCore;

namespace Arah.Modules.Connections.Infrastructure.Postgres;
...
public sealed class PostgresConnectionPrivacySettingsRepository : IConnectionPrivacySettingsRepository
{
    ...
    public PostgresConnectionPrivacySettingsRepository(ConnectionsDbContext db)
    {
        _db = db;
    }
    ...
    {
        var record = await _db.ConnectionPrivacySettings
            .AsNoTracking()
    ...
    public Task<ConnectionPrivacySettings> AddAsync(ConnectionPrivacySettings settings, CancellationToken cancellationToken)
    {
        ...
        _db.ConnectionPrivacySettings.Add(record);
