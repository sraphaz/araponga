...
| Feed posts/eventos | `docs/USER_STORIES.md` | MVP | `backend/Araponga.Api/Controllers/FeedController.cs` (CreatePost exige GeoAnchors) | Posts sem GeoAnchor obrigatório. | GeoAnchors 1..N validados e persistidos. |
