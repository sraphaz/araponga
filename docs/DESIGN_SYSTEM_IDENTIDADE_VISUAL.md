...
**Estilos**
- **Interno**: Cor link (azul), underline on hover
- **Externo**: Cor link + ícone, underline on hover
- **Inativo/Disabled**: Cor muted, no interaction

**Estados**
- Default: Cor base
- Hover: Cor mais clara, underline
- Focus: Outline claro visível (acessibilidade)
...
### 7.1 Antes de Publicar Qualquer Material
