...
Consulte **[docs/CURSOR_DOCUMENTATION_RULES.md](./CURSOR_DOCUMENTATION_RULES.md)** para mapeamento completo de:
...
- [ ] Documentação de fase atualizada (se completar fase)
...
- **[Regras de Documentação para Agentes](./CURSOR_DOCUMENTATION_RULES.md)** - Guia completo
- **[Índice da Documentação](./00_INDEX.md)** - Navegação completa
- **[Backlog API](./backlog-api/README.md)** - 29 fases planejadas
- **[Status das Fases](./STATUS_FASES.md)** - Status atual de todas as fases
