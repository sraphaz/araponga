...
**Status**: ⏳ Pendente  
**Nota**: Renumerada de Fase 28 e Fase 29 para Fase 48, reposicionada para Onda 10 (Diferenciação Avançada). Referências atualizadas: Fase 17→42.
...
#### 48.1 Modelo de Domínio - Banco de Sementes
...
#### 48.2 Sistema de Banco de Sementes
...
#### 48.3 Sistema de Doações de Sementes
**Estimativa**: 24 horas (3 dias)  
**Status**: ❌ Não implementado
...
#### 48.4 Sistema de Solicitações de Sementes
**Estimativa**: 24 horas (3 dias)  
**Status**: ❌ Não implementado
...
#### 48.5 Integração com Marketplace
...
- [ ] Preços:
  - [ ] Preço 0 para doações
  - [ ] Preço opcional para venda (moeda territorial - Fase 22)
- [ ] Atualizar `StoreItem`:
...
#### 48.6 Sistema de Plantio e Rastreabilidade
...
- [ ] Integração com Gamificação:
  - [ ] Plantio bem-sucedido: +15 pontos (Fase 42)
  - [ ] Multiplicação de sementes: +15 pontos
- [ ] Testes unitários
...
#### 48.7 Eventos de Trocas de Sementes
**Estimativa**: 16 horas (2 dias)  
**Status**: ❌ Não implementado
...
- [ ] Criar modelo `SeedSwapEvent`:
  ...
  - [ ] `SwapRules` (string?)
  - [ ] `AllowsSale` (bool)
  - [ ] `UsesTerritoryCurrency` (bool, Fase 22)
...
- [ ] Integração com Gamificação:
  - [ ] Organizar evento: +50 pontos (Fase 42)
...
#### 48.8 Integração com Alertas e Notificações
...
## ✅ Critérios de Sucesso da Fase 48
...
- Considerar **Testcontainers + PostgreSQL** para testes de integração (banco de sementes, catálogo, WorkQueue) com banco real (estratégia na Fase 43; [TESTCONTAINERS_POSTGRES_IMPACTO](../../TESTCONTAINERS_POSTGRES_IMPACTO.md)).
